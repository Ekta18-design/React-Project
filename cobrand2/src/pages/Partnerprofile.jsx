					...
					<div id="kt_header" class="header">
						...
						<div class="container-fluid d-flex align-items-center flex-wrap justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 pb-5 pb-lg-0 pt-7 pt-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								...
								<h1 class="d-flex flex-column text-gray-900 fw-bold my-0 fs-1">Partner Profile Page</h1>
							
								<ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
									<li class="breadcrumb-item text-muted">
										<a href="index.html" class="text-muted text-hover-primary">Home</a>
									</li>
									<li class="breadcrumb-item text-muted">Partner Profile Page</li>
											...
											<form action="#" class="form mb-15" method="post" id="kt_careers_form">
												...
												<div class="row mb-5">
													...
													<div class="col-md-6 fv-row">
														...
														<label class="fs-5 fw-semibold mb-2">Contact Name</label>
														
														<input type="text" id="contactname" class="form-control form-control-solid" placeholder="" name="contactname" />
												...
												<div class="row mb-5">
													...
													<div class="col-md-6 fv-row">
														...
														<input type="text" id="website" class="form-control form-control-solid" placeholder="" name="website" />
												...
												<div class="row mb-5">
													...
													<div class="col-md-6 fv-row">
														...
														<label class="fs-5 fw-semibold mb-2">Upload Logo</label>
														
														<input type="file" id="uploadlogo" class="form-control form-control-solid" placeholder="" name="uploadlogo" />
													
													</div>
													
													<div class="col-md-6 fv-row">
												
														<label class="fs-5 fw-semibold mb-2">Upload Photo</label>
														
														<input type="file" id="uploadphoto" class="form-control form-control-solid" placeholder="" name="uploadphoto" />
										...
										<div class="col-xl-4 mb-xl-10">
											...
											<div class="mb-2">											
												...
												<div class="text-center">
													<img src="assets/media/bg1.jpg" style={{height:'100px',width:'100%'}} alt="" />
													</div>
											...
											<div class="mb-2">											
												...
												<div class="text-center">
													<img src="assets/media/bg1.jpg" style={{height:'200px', width:'100%'}} alt="" />
													</div>
